...
is_resp qw{search_date -exclude debris 2009-04-01}, {
	...
	method => 'GET',
	url => "$base_url/basicspacedata/query/class/satcat/format/json/orderby/OBJECT_NUMBER%20asc/predicates/all/CURRENT/Y/DECAY/null-val/LAUNCH/2009-04-01/OBJECT_TYPE/PAYLOAD,ROCKET%20BODY,UNKNOWN,OTHER",
	version => 2,
    },
;
...
is_resp qw{search_date -exclude rocket 2009-04-01}, {
	...
	method => 'GET',
	url => "$base_url/basicspacedata/query/class/satcat/format/json/orderby/OBJECT_NUMBER%20asc/predicates/all/CURRENT/Y/DECAY/null-val/LAUNCH/2009-04-01/OBJECT_TYPE/PAYLOAD,DEBRIS,UNKNOWN,OTHER",
	version => 2,
    },
;

{
    ...
    is_resp qw{search_date -exclude debris,rocket 2009-04-01}, {
	    ...
	    method => 'GET',
	    url => "$base_url/basicspacedata/query/class/satcat/format/json/orderby/OBJECT_NUMBER%20asc/predicates/all/CURRENT/Y/DECAY/null-val/LAUNCH/2009-04-01/OBJECT_TYPE/PAYLOAD,UNKNOWN,OTHER",
	version => 2,
	},
    ;
}
...
is_resp qw{search_id -exclude debris 98067}, {
	...
	method => 'GET',
	url => "$base_url/basicspacedata/query/class/satcat/format/json/orderby/OBJECT_NUMBER%20asc/predicates/all/CURRENT/Y/DECAY/null-val/OBJECT_ID/~~1998-067/OBJECT_TYPE/PAYLOAD,ROCKET%20BODY,UNKNOWN,OTHER",
	version => 2,
    },
;
...
is_resp qw{search_id -exclude rocket 98067}, {
	...
	method => 'GET',
	url => "$base_url/basicspacedata/query/class/satcat/format/json/orderby/OBJECT_NUMBER%20asc/predicates/all/CURRENT/Y/DECAY/null-val/OBJECT_ID/~~1998-067/OBJECT_TYPE/PAYLOAD,DEBRIS,UNKNOWN,OTHER",
	version => 2,
    },
;

{
    ...
    is_resp qw{search_id -exclude debris,rocket 98067}, {
	    ...
	    method => 'GET',
	    url => "$base_url/basicspacedata/query/class/satcat/format/json/orderby/OBJECT_NUMBER%20asc/predicates/all/CURRENT/Y/DECAY/null-val/OBJECT_ID/~~1998-067/OBJECT_TYPE/PAYLOAD,UNKNOWN,OTHER",
	version => 2,
	},
    ;
}
...
is_resp qw{search_name -exclude debris ISS}, {
	...
	method => 'GET',
	url => "$base_url/basicspacedata/query/class/satcat/format/json/orderby/OBJECT_NUMBER%20asc/predicates/all/CURRENT/Y/DECAY/null-val/OBJECT_NAME/~~ISS/OBJECT_TYPE/PAYLOAD,ROCKET%20BODY,UNKNOWN,OTHER",
	version => 2,
    },
;
...
is_resp qw{search_name -exclude rocket ISS}, {
	...
	method => 'GET',
	url => "$base_url/basicspacedata/query/class/satcat/format/json/orderby/OBJECT_NUMBER%20asc/predicates/all/CURRENT/Y/DECAY/null-val/OBJECT_NAME/~~ISS/OBJECT_TYPE/PAYLOAD,DEBRIS,UNKNOWN,OTHER",
	version => 2,
    },
;

{
	...
	method => 'GET',
	url => "$base_url/basicspacedata/query/class/satcat/format/json/orderby/OBJECT_NUMBER%20asc/predicates/all/CURRENT/Y/DECAY/null-val/OBJECT_NAME/~~ISS/OBJECT_TYPE/PAYLOAD,UNKNOWN,OTHER",
	version => 2,
	},
    ;
}
