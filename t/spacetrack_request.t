...
is_resp qw{retrieve -start_epoch 2009-04-01 25544}, {
	...
	method => 'GET',
	url => "$base_url/basicspacedata/query/class/tle/NORAD_CAT_ID/25544/EPOCH/2009-04-01--2009-04-02/format/tle/orderby/EPOCH%20desc",
	version => 2,
    },
;
...
is_resp qw{retrieve -end_epoch 2009-04-01 25544}, {
	...
	method => 'GET',
	url => "$base_url/basicspacedata/query/class/tle/NORAD_CAT_ID/25544/EPOCH/2009-03-31--2009-04-01/format/tle/orderby/EPOCH%20desc",
	version => 2,
    },
;
...
is_resp qw{retrieve -start_epoch 2009-03-01 -end_epoch 2009-04-01 25544}, {
	...
	method => 'GET',
	url => "$base_url/basicspacedata/query/class/tle/NORAD_CAT_ID/25544/EPOCH/2009-03-01--2009-04-01/format/tle/orderby/EPOCH%20desc",
	version => 2,
    },
;
