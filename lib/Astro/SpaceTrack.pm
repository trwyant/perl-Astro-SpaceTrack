...
#	sladen => undef,	# Not needed; done programmatically.
    ...
    # on Tue Oct  3 21:09:51 2017 GMT
	...
	[ 24947, 'Iridium 27', '[D]', 'Decayed', 3 ],
	[ 24948, 'Iridium 28', '[?]', 'SpaceTrack', 2 ],
	[ 24949, 'Iridium 30', '[D]', 'Decayed', 3 ],
	...
	[ 25470, 'Iridium 79', '[D]', 'Decayed', 3 ],
	[ 25471, 'Iridium 77', '[D]', 'Decayed', 3 ],
	[ 25527, 'Iridium 2', '[?]', 'SpaceTrack', 2 ],
	[ 25528, 'Iridium 86', '[?]', 'SpaceTrack', 2 ],
	[ 25529, 'Iridium 85', '[D]', 'Decayed', 3 ],
	...
	my ( $opt, $fmt ) = _parse_args( [
		'raw!'	=> 'Do not suppliment with kelso data'
	    ], @args );
	defined $fmt
...
#			warn "No oid for Iridium $num\n";
	...
	foreach my $body ( @{ $data } ) {
		...
		defined $body->{DECAY} ?
		( '[D]', 'Decayed', BODY_STATUS_IS_DECAYED ) :
